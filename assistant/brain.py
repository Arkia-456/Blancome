...
from commands.music.previous import PreviousCommand
from commands.music.shuffle import ShuffleCommand
...
class Brain:
	def __init__(self, require_wake_word: bool = False):
		...
		self._commands: list[Command] = [PlayCommand(), StopCommand(), NextCommand(), PreviousCommand(), PauseCommand(), ShuffleCommand(), AddCommand(), SendSmsCommand(), ListCommand()]
